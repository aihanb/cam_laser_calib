                                        ...
                                        const cv::Size& imageSize)
{
    ...
    //cout<<"Reached drawPointcloudColor"<<endl;
    //cout<<"cloud_in->points.size(): "<<cloud_in->points.size()<<endl;
    //cout<<"cameraMat.at<double>(0,0): "<<cameraMat.at<double>(0,0)<<endl;
    //cout<<"cameraMat.at<double>(0,2): "<<cameraMat.at<double>(0,2)<<endl;
    //cout<<"cameraMat.at<double>(1,1): "<<cameraMat.at<double>(1,1)<<endl;
    //cout<<"cameraMat.at<double>(1,2): "<<cameraMat.at<double>(1,2)<<endl;
    ...
    for (size_t i = 0; i < cloud_in->points.size(); i++)
    {
        ...
        //cout<<"point.at<double>(0): "<<point.at<double>(0)<<endl;
        //cout<<"point.at<double>(1): "<<point.at<double>(1)<<endl;
        //cout<<"point.at<double>(2): "<<point.at<double>(2)<<endl;
